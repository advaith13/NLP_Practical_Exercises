...
2. Process the data
	    3. Build the NLI model BERT
	    4. Compile the model
## DESCRIPTION / PROCEDURE
Colab Link
https://colab.research.google.com/drive/1-AGumhx2oFANovfqw4T62TK25hYpO5Vp#scrollTo=vVposfiWaeD1
...
Output:
```
loss 0.519, train acc 0.790, test acc 0.780
10166.0 examples/sec on [device(type='cuda', index=0), device(type='cuda', index=1)]
```
